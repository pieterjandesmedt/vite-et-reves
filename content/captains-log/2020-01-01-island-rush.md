...
We put one {{% explain "reef" "make the sail smaller by rolling it in or lowering it a bit" %}} in the main as the grib files predicted 20 knots of wind. Usually their predictions are on the low side.
